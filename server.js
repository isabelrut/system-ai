      ...
      messages: [
        {
          ...
          `
            ...
            6.  The perspective determines what details should be more extensive, choosing between business (financial, business case), ICT (implementation), and sustainability (how to leverage).
